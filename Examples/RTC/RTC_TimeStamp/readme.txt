...
1.It configures the RTC TimeStamp pin（PC13） to be falling edge and enables the TimeStamp detection.
2.When RTC_TimeStamp pin（PC13） is on the air, a interrupt will be generated and print TimeStamp information to serial assistant.
